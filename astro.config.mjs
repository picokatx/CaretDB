    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [ // Keep manual links for non-table pages
          ...
          { label: 'Query Definitions', link: '/docs/database/query-definitions/' },
          {
            label: 'Query Details', // Add new autogenerated section
            autogenerate: { directory: 'docs/database/query-details' }
          },
