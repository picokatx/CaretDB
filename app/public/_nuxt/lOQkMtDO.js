import{B as r,o as p,c as d,j as s,m as o,s as u,a5 as c}from"./D6JOse8H.js";var f=function(n){var t=n.dt;return`
.p-floatlabel {
    display: block;
    position: relative;
}
...
`)},y={root:function(n){var t=n.instance,e=n.props;return["p-inputtext p-component",{"p-filled":t.$filled,"p-inputtext-sm p-inputfield-sm":e.size==="small","p-inputtext-lg p-inputfield-lg":e.size==="large","p-invalid":t.$invalid,"p-variant-filled":t.$variant==="filled","p-inputtext-fluid":t.$fluid}]}},w=r.extend({name:"inputtext",theme:F,classes:y}),k={name:"BaseInputText",extends:g,style:w,provide:function(){return{$pcInputText:this,$parentInstance:this}}},_={name:"InputText",extends:k,inheritAttrs:!1,methods:{onInput:function(n){this.writeValue(n.target.value,n)}},computed:{attrs:function(){return o(this.ptmi("root",{context:{filled:this.$filled,disabled:this.disabled}}),this.formField)}}},V=["value","disabled","aria-invalid"];function I(l,n,t,e,a,i){return p(),d("input",o({type:"text",class:l.cx("root"),value:l.d_value,disabled:l.disabled,"aria-invalid":l.$invalid||void 0,onInput:n[0]||(n[0]=function(){return i.onInput&&i.onInput.apply(i,arguments)})},i.attrs),null,16,V)}_.render=I;export{g as a,m as b,_ as s};
